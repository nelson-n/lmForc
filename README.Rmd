...
Pre-print version of [lmForc: Linear Model Forecasting in R](https://cran.r-project.org/web/packages/lmForc/vignettes/lmForc.html), submitted to the [R Journal](https://journal.r-project.org/).
